...
// private functions
nodeaddr_t bintree_pred_rec(nodeaddr_t curr, ptr_node_t pn, ptr_node_t ppn, nodeaddr_t* ppa);
nodeaddr_t bintree_pred(nodeaddr_t curr, ptr_node_t pn, ptr_node_t ppn, nodeaddr_t* ppa);
...
int bintree_remove_rec(nodekey_t k, nodeaddr_t curr, ptr_node_t p, nodeaddr_t* pna);
...
nodeaddr_t bintree_pred_rec(nodeaddr_t curr, ptr_node_t p, ptr_node_t ppn, nodeaddr_t * ppa) {
